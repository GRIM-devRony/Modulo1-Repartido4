...
import { Form, Label, ContenedorTerminos, ContenedorBotonCentrado, Boton, MensajeExito, MensajeError } from '../../components/form/form';
import "./Contacto.css"
...
const Contacto = () => {
  ...
  const onSubmit = (e) => {
    ...
    if (
      ...
      navigate(`/agradecimiento/${nombre.campo}`)
    } else {
